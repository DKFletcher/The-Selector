	...
	func applicationDidFinishLaunching(_: UIApplication) {
		(window!.rootViewController as! TabBarController).emotions =
			[EmotionItems(
				...
				stage : .third,
				ring: .stretchingMe,
				emotion: Index(emotion: .admiring),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .arrogant),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .connectingMe,
				emotion: Index(emotion: .belonging),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .connectingMe,
				emotion: Index(emotion: .compassionate),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .stretchingMe,
				emotion: Index(emotion: .confident),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .contempt),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .stretchingMe,
				emotion: Index(emotion: .determined),
			 ...
			 EmotionItems(
				...
				stage : .first,
				ring: .protectingMe,
				emotion: Index(emotion: .embarrassed),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .connectingMe,
				emotion: Index(emotion: .empatheticJoy),
			 ...
			 EmotionItems(
				...
				stage : .first,
				ring: .stretchingMe,
				emotion: Index(emotion: .enthusiastic),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .entitled),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .connectingMe,
				emotion: Index(emotion: .forgiving),
			 ...
			 EmotionItems(
				...
				stage : .first,
				ring: .meFirst,
				emotion: Index(emotion: .frustrated),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .gloating),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .protectingMe,
				emotion: Index(emotion: .humiliated),
			 ...
			 EmotionItems(
				...
				stage : .first,
				ring: .stretchingMe,
				emotion: Index(emotion: .exhilarated),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .protectingMe,
				emotion: Index(emotion: .overwhelmed),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .resentful),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .connectingMe,
				emotion: Index(emotion: .responsible),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .protectingMe,
				emotion: Index(emotion: .selfDoubting),
			 ...
			 EmotionItems(
				...
				stage : .third,
				ring: .meFirst,
				emotion: Index(emotion: .spiteful),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .connectingMe,
				emotion: Index(emotion: .thankful),
			 ...
			 EmotionItems(
				...
				stage : .second,
				ring: .connectingMe,
				emotion: Index(emotion: .trusting),
